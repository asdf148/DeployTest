...
export class ProductService {
    constructor(
        ...
        @InjectRepository(SubCategoryRepository) private subCategoryRepository: SubCategoryRepository,
    ){}
    ...
    async create(user:TokenContext, createProduct:CreateProduct){
        ...
        product.category = await this.categoryRepository.findOneByName(createProduct.category);
        product.subCategory = await this.subCategoryRepository.findOneByName(createProduct.subCategory);
